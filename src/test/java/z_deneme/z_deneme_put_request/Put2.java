...
public class Put2 extends DummyRestApiBaseUrl {
    ...
    public void put01() {
        ...
        DummyApiDataPojo innerData = new DummyApiDataPojo("Tom Hanks", 111111, 23, "Perfect image");
        DummyApiResponseBodyPojo expectedData = new DummyApiResponseBodyPojo("success", innerData, "Successfully! Record has been updated.");

        Response response = given().spec(spec).contentType(ContentType.JSON).body(innerData).when().put("/{first}/{second}");

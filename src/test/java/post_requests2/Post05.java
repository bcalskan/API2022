 ...
 */
    ...
    public void post01() {
        ...
        assertEquals(dummyApiDataPojo.getEmployee_name(), actualData.getData().getEmployee_name());
        assertEquals(dummyApiDataPojo.getEmployee_salary(), actualData.getData().getEmployee_salary());
        assertEquals(dummyApiDataPojo.getEmployee_age(), actualData.getData().getEmployee_age());
        assertEquals(dummyApiDataPojo.getProfile_image(), actualData.getData().getProfile_image());
